...
VALUES (UUID(), TRUE, 'Car Shifting');
INSERT INTO SERVICE_TYPES
VALUES (UUID(), TRUE, 'House Shifting');
INSERT INTO SERVICE_TYPES
VALUES (UUID(), TRUE, 'Cooperate Shifting');
INSERT INTO SERVICE_TYPES
VALUES (UUID(), TRUE, 'Packing');

INSERT INTO PACKERS
VALUES (UUID(), 'Huston', 'Des', 'hustonpackers@gmail.com', 'Huston move smart', 12312313, 'Huston',
        (SELECT id FROM USER_DETAILS WHERE email = 'p'));

INSERT INTO PACKERS
VALUES (UUID(), 'Anytown', 'Des', 'anytown@gmail.com', 'Anytown logistics', 98765234, 'CA',
...
VALUES ((SELECT id FROM PACKERS WHERE email = 'hustonpackers@gmail.com'),
        (SELECT id FROM SERVICE_TYPES WHERE service_type = 'Car Shifting'));
INSERT INTO PACKER_SERVICE
VALUES ((SELECT id FROM PACKERS WHERE email = 'hustonpackers@gmail.com'),
        (SELECT id FROM SERVICE_TYPES WHERE service_type = 'House Shifting'));
INSERT INTO PACKER_SERVICE
VALUES ((SELECT id FROM PACKERS WHERE email = 'anytown@gmail.com'),
        (SELECT id FROM SERVICE_TYPES WHERE service_type = 'Car Shifting'));
INSERT INTO PACKER_SERVICE
VALUES ((SELECT id FROM PACKERS WHERE email = 'anytown@gmail.com'),
        (SELECT id FROM SERVICE_TYPES WHERE service_type = 'House Shifting'));
...
VALUES ((SELECT id FROM PACKERS WHERE email = 'Boston@gmail.com'),
        (SELECT id FROM SERVICE_TYPES WHERE service_type = 'Cooperate Shifting'));


INSERT INTO QUOTATION
VALUES (UUID(), '3231', 'comments', '2022-12-10', 'des', 'active',
        (SELECT id FROM PACKERS WHERE email = 'anytown@gmail.com'),
        (SELECT id FROM USER_DETAILS WHERE email = 'user@gmail.com'),
        (SELECT id FROM SERVICE_TYPES WHERE SERVICE_TYPE = 'House Shifting'));
INSERT INTO QUOTATION
VALUES (UUID(), '231', 'comments', '2023-04-10', 'des', 'active',
        (SELECT id FROM PACKERS WHERE email = 'hustonpackers@gmail.com'),
        (SELECT id FROM USER_DETAILS WHERE email = 'user@gmail.com'),
        (SELECT id FROM SERVICE_TYPES WHERE SERVICE_TYPE = 'Car Shifting'));
INSERT INTO QUOTATION
